...
public class BrandDAOImpl extends HibernateDaoSupport implements IBrandDAO{
	...
	public static BrandDAOImpl getFromApplicationContext(ApplicationContext ctx) {
		return (BrandDAOImpl) ctx.getBean("BrandDAO");
	}
}