...
import cc.momas.blog.dto.BlogQuery;
import cc.momas.blog.dto.SearchBlog;
import cc.momas.blog.dto.ShowBlog;
import cc.momas.blog.pojo.Blog;
...
public class BlogController {
    ...
    public String delete(@PathVariable Long id, RedirectAttributes attributes) {
        final ShowBlog blogById = blogService.getBlogById(id);
        if (null != blogById) {
            logService.addLog("删除博客", blogById.getContent());
        }
    ...
    public String add(Blog blog, RedirectAttributes attributes, HttpSession session) {
        ...
        logService.addLog("添加博客", blog.getTitle());
        return "redirect:/admin/blogs";
    }
    ...
    public String editPost(ShowBlog showBlog, RedirectAttributes attributes) {
        ...
        logService.addLog("编辑博客", showBlog.getTitle());
        return "redirect:/admin/blogs";
    }
