  ...
  <body>
     <div class="container-fluid" >
        ...
        <div class="col-md-6 col-md-offset-3">
            ...
            <h4 style="font-weight: bold;"><img src="img/xiao22.jpg">&nbsp;&nbsp;&nbsp;维护投票</h4>
            <div class="row">
            ...
            -->
                ...
                <ul style="list-style:none; margin-left:-20px; width:450px;">
                    ...
                    <li class="alert alert-info">投票内容:<input type="text" class="form-control" placeholder="要修改的那条信息的内容" ></li>
					<li class="alert alert-info">投票类型:&nbsp;&nbsp;&nbsp;<input type="radio" name="xuan"/>单选 <input type="radio" name="xuan"/>多选</li>
                ...
                <button type="button" class="btn btn-success">添加选项</button>
